...
copy ..\..\.zidar\windows\vs2022\MTuner\x64\retail\bin\MTuner_retail.exe        MTuner.exe

copy ..\..\.zidar\windows\vs2022\MTuner\x64\retail\bin\Qt6Core.dll              Qt6Core.dll
copy ..\..\.zidar\windows\vs2022\MTuner\x64\retail\bin\Qt6Gui.dll               Qt6Gui.dll
...
copy ..\..\.zidar\windows\vs2022\MTuner\x32\retail\bin\MTunerDLL_retail.dll     MTunerDLL32.dll
copy ..\..\.zidar\windows\vs2022\MTuner\x64\retail\bin\MTunerDLL_retail.dll     MTunerDLL64.dll

copy ..\..\.zidar\windows\vs2022\MTuner\x64\retail\bin\platforms\qwindows.dll   platforms\qwindows.dll
...
copy ..\..\src\libs\rmem\scripts\genie.lua				SDK\scripts\genie.lua
copy ..\..\src\libs\rmem\scripts\rmem.lua				SDK\scripts\rmem.lua
