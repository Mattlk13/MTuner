...
pushd ..
zidar\tools\bin\windows\genie.exe --file=src\libs\rmem\scripts\genie.lua --gcc=%PLATFORM% gmake
popd
cd ..\.zidar\%PLATFORM%\%PLATFORM%-clang\rmem\projects\
...
copy ..\.zidar\%PLATFORM%\%PLATFORM%-clang\rmem\x64\debug\lib\librmem_debug.a SDK\lib\%PLATFORM_SHORT%\librmem_debug.a
copy ..\.zidar\%PLATFORM%\%PLATFORM%-clang\rmem\x64\release\lib\librmem_release.a SDK\lib\%PLATFORM_SHORT%\librmem_release.a
